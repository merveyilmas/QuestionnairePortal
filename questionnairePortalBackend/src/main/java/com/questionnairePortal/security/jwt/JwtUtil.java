...
public class JwtUtil {
    ...
    private String createToken(Map<String, Object> claims, String subject) {
        return Jwts.builder().setClaims(claims)
                ...
                //.setExpiration(new Date(System.currentTimeMillis() + 5 * 60 * 60 * 1000)) // jwt token kullanım süresi, bitiş (5 saat)
                .setExpiration(new Date(System.currentTimeMillis() + 30 * 24 * 60 * 60 * 1000L)) // (1 ay)
